...
<body>
   <!--Preloader Start-->
   <div class="preloader">
      <div class="loading-text"> <span class="loading-text-words" data-preloader="L">L</span>
                  ...
                  <div class="header_inn">
                     <div class="row">
                        <div class="col-lg-5">
                           <div class="site-logo">
                              <a href="index.html">
                                 <img src="assets/img/logo_1.png" width="100" height="20px" alt="Peulis" />
                              </a>
                           </div>
                           ...
                           <div class="header_action">
                              <ul>
                                 <li class="header-search">
                                    ...
                                    <div class="search-box search-elem"> <span class="search-close"></span>
                                       <div class="inner row">
                                          <form>
                                 ...
                                 <li class="header_cart">
                                    ...
                                    <div class="cart_box_hover">
                                       <div class="single-cart">
                                          <a class="product-remove" href="#"> <i class="fa fa-times"></i>
                                          </a>
                                       ...
                                       <div class="single-cart subtotal">
                                          <p>Subtotal :<span>$3300</span>
                                          </p>
                                       </div>
                                       <div class="cart-action"> <a href="cart.html" class="viewcart">view cart</a>
                                          <a href="checkout.html" class="checkout-btn">Checkout</a>
                                       </div>
                                    </div>
                                 </li>
                                 <li><a href="#" id="sidenav-toggle"><i class="fa fa-bars"></i></a>
                                 </li>
                              </ul>
                           </div>
                        </div> -->
